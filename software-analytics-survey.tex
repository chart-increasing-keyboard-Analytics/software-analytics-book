...
project's source code. All artifacts required to build the project
...
as the developer would expect it to behave.
...
relevant changes. This ensures that communication trickels down to all
programmers and that everyone can see what's happening.
...
test server that everyone can look at.
