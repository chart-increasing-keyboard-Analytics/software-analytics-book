...
continuous integration such as Travis CI\footnote{\url{https://travis-ci.org/}},
Circle
CI\textsuperscript{{[}\url{https://circleci.com/}{]},Jenkins}{[}\url{https://jenkins.io/}{]},
AppVeyor\footnote{\url{https://www.appveyor.com/}} and
TeamCity\footnote{\url{https://www.jetbrains.com/teamcity/}} or surveys
among developers about their usage of Continuous Integration or build
systems. This information is often paired with data from Version Control
Systems (VCS) such as git.
...
findings that the state-of-the-art papers display. \textbf{RQ2}: What is
the current state of practice in the field of build analytics?
...
\citet{beller2017travistorrent}, \citet{pinto2018work}, 1,
\citet{widder2018m} and \citet{hilton2016usage} we used references to
...
\item
  ...
  \tightlist
  \item
    How do teams change their pull request review practices in response
    to the introduction of continuous integration?
  \end{enumerate}
\item
\end{itemize}
...
\subsection{1}\label{zhao2017impact}
