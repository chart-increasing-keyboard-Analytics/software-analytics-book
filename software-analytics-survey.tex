...
\citet{bird2017predicting}, Beller et al. \citet{beller2017oops}, Rausch
et al. \citet{rausch2017empirical}, Beller et al. TravisTorrent
\citet{beller2017travistorrent}, Pinto et al. \citet{pinto2018work},
Zhao et al. \citet{zhao2017impact}, Widder et al. \citet{widder2018m}
and Hilton et al. \citet{hilton2016usage}, we used references to find
new papers to analyze. Moreover, we used academical search engines like
\emph{GoogleScholar} to perform a keyword based search for other
...
1. Bird and Zimmermann 2017 \citet{bird2017predicting}\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
2. Beller et al. 2017 \citet{beller2017oops}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ3\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
3. Rausch et al. 2017 \citet{rausch2017empirical}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ2\strut
...
\citet{beller2017travistorrent}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ2\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
5. Pinto et al. 2018 \citet{pinto2018work}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ3\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
6. Zhao et al. 2017 \citet{zhao2017impact}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ3\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
7. Widder et al. 2018 \citet{widder2018m}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ1\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
8. Hilton et al. 2016 \citet{hilton2016usage}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ2\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
9. Vassallo et al. 2017 \citet{vassallo2017tale}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Ref 2\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
-\strut
...
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
11. Hassan and Wang
\href{mailto:2018@hassan2018hirebuild}{\nolinkurl{2018@hassan2018hirebuild}}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Ref 4\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ1\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
12. Vassallo et al. 2018 \citet{vassallo2018break}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Ref 2,3\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ1, RQ3\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
13. Zampetti et al. 2017 \citet{zampetti2017open}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
Ref by 12\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
-\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
14. Baltes et al. 2018 \citet{baltes2018no}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
15. Bisong et al. 2017 \citet{bisong2017built}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
GScholar Search\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ1, RQ3\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
16. Santolucito et al. 2018 \citet{santolucito2018statically}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
GScholar Search\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ1\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
17. Ni and Li 2018 \citet{ni2018acona}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
GScholar Search\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ1\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
18. Fowler and Foemmel 2006 \citet{fowler2006continuous}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
GScholar Search\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ2\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.56\columnwidth}\raggedright\strut
19. Stolberg 2009 \citet{stolberg2009enabling}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright\strut
GScholar Search\strut
\end{minipage} & \begin{minipage}[t]{0.08\columnwidth}\raggedright\strut
RQ2\strut
...
\citet{bird2017predicting} introduce a method for predicting software
...
efficiency. One of the papers that addresses this matters is
...
\chapter{\texorpdfstring{\emph{Initial
Seed}}{Initial Seed}}\label{initial-seed}
...
claims that CI is widely used in practice nowadays. The paper by
...
by \citet{fowler2006continuous}. The practices presented by
...
\textless{}\textless{}\textless{}\textless{}\textless{}\textless{}\textless{}
HEAD This paper defines CI as a key element in agile software
development and testing environment. It also uses Marin Fowler's
practises of CI (as discussed previously) and expresses the importance
of CI in the software industry.\\
======= Some open research questions from recent papers are the
following:
...
\subsection{Initial seed}\label{initial-seed-2}
