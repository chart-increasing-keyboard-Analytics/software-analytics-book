...
like \emph{Google} \emph{Scholar} to perform a keyword based search for
other relevant build analytics domain papers. The keywords used were:
build analytics, machine learning, build time, prediction, continuous
...
\item
  {[}\protect\hyperlink{ref-santolucito2018statically}{104}{]}
\item
  {[}\protect\hyperlink{ref-baltes2018no}{8}{]}
\item
...
Baltes et al.{[}\protect\hyperlink{ref-baltes2018no}{8}{]} suggests that
