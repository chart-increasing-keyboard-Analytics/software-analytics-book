...
\citet{fowler2006continuous} present. Furthermore, it will discuss the
...
IBM's Grady Booch first proposed the methodology of Continuous
Integration in the 1990s. It became widely used when adopted by Extreme
Programming in the 1996. In 2000, \citet{fowler2006continuous} wrote the
cornerstone description of integration practises. The following section
provides critical analysis of the papers presented and explains the
